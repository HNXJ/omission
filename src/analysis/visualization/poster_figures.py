...
Data flows:
  src/analysis/io/loader.py         -> DataLoader
  src/analysis/lfp/lfp_preproc.py   -> preprocess_lfp / baseline_normalize
  src/analysis/lfp/lfp_tfr.py       -> compute_multitaper_tfr / collapse_band_power
  src/analysis/spiking/stats.py     -> mean_sem
  src/analysis/lfp/lfp_connectivity.py -> compute_coherence
  src/analysis/spiking/omission_hierarchy_utils.py -> extract_unit_traces
