...
def plot_mi_matrix(results: dict, output_dir: str):
    ...
    for area, pop_csd in results.items():
        plotter = OmissionPlotter(title=f"Figure f012: {area} Current Source Density (CSD)",
            x_label="Time", y_label="Sink/Source Intensity",
    ...
    # Plot global summary
    if results:
        plotter = OmissionPlotter(title="Figure f012: Global Current Source Density (CSD)",
            x_label="Time", y_label="Sink/Source Intensity",
