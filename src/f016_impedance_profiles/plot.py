...
def plot_impedance(results: dict, output_dir: str):
    ...
    plotter_mag = OmissionPlotter(title=f"Figure 16: Impedance Mag (Session {results['session']})", subtitle="Magnitude")
    ...
    plotter_phase = OmissionPlotter(title=f"Figure 16: Impedance Phase (Session {results['session']})", subtitle="Phase (deg)")
