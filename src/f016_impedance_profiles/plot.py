...
def plot_impedance(results: dict, output_dir: str):
    ...
    plotter_mag = OmissionPlotter(title=f"Figure 16: Impedance Mag (Session {results['session']})", 
                                  x_label="Frequency", y_label="Impedance (kOhm)", subtitle="Magnitude")
    ...
    plotter_phase = OmissionPlotter(title=f"Figure 16: Impedance Phase (Session {results['session']})", 
                                    x_label="Frequency", y_label="Impedance (kOhm)", subtitle="Phase (deg)")
