...
- **Current Objective**: Finalize PLOS ONE rebuttal for GSDR01 (Kappa synchrony minimization, biological data comparison for 0818/0825). Perform rapid NWB signal analysis (LFP, MUAe) for the same sessions.
