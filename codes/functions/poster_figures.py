...
def plot_band_power_hierarchy(
    ...
    Example
    -------
    >>> from codes.functions.lfp_io import load_condition_table
    >>> from codes.functions.lfp_preproc import baseline_normalize, extract_epochs
    >>> from codes.functions.lfp_tfr import get_band_power
    >>> from codes.functions.lfp_stats import mean_sem
    >>> from codes.functions.poster_figures import plot_band_power_hierarchy
    >>>
...
def plot_mua_tfr_panel(
    ...
    Example
    -------
    >>> from codes.functions.lfp_tfr import compute_tfr
    >>> from codes.functions.lfp_stats import mean_sem
    >>> tfr_data = {}
    >>> mua_traces = {}
...
def plot_spectral_corr_matrices(
    ...
    ----------------------------------
    >>> from codes.functions.lfp_tfr import get_band_power, collapse_band_power
    >>> from codes.functions.lfp_stats import mean_sem
...
def plot_neuron_group_traces(
    ...
    Example
    -------
    >>> from codes.functions.omission_hierarchy_utils import extract_unit_traces
