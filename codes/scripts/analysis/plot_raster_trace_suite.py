...
def plot_unit_raster_trace_suite(session, probe_id, local_idx, area_label, filename_tag):
    """
...
if __name__ == "__main__":
    # Representative Units from the ratio audit
    tasks = [
        (230630, 1, 44, "V4_MT", "ratio_1.01_1.25"),
        (230630, 1, 10, "V4_MT", "ratio_1.25_1.50"),
        (230818, 0, 101, "PFC", "ratio_1.50_1.75"),
        (230816, 1, 13, "V4_MT", "ratio_1.75_2.00"),
        (230818, 0, 34, "PFC", "ratio_2.0plus")
    ]
    for ses, prb, l_idx, area, tag in tasks:
        plot_unit_raster_trace_suite(ses, prb, l_idx, area, tag)
