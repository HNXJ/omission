...
from codes.functions.lfp_constants import BANDS, SEQUENCE_TIMING, GOLD, VIOLET, TEAL, ORANGE, BLACK, GRAY
from codes.functions.lfp_plotting import create_band_plot
