"""
layer_mapping_omission_v2.py: Maps identified omission neurons to cortical layers (Superficial, L4, Deep)
...
# Paths
UNITS_LAYERED_PATH = r'D:\Analysis\Omission\local-workspace\checkpointseal_omission_units_layered_v3.csv' # Corrected path
LATENCY_PATH = r'D:\Analysis\Omission\local-workspace\checkpoints\omission_latencies_v2.csv' # Assuming latest latency file
VFLIP_SUMMARY_PATH = r'D:\Analysis\Omission\local-workspace\LFP_Extractions\vflip2_summary.txt'
NWB_DIR = r'D:\Analysis\Omission\local-workspace\data' # NWB files are now in data/
OUTPUT_PATH = r'D:\Analysis\Omission\local-workspace\checkpointseal_omission_units_layered_v3_final.csv' # Save to a new file
...
def map_layers():
    ...
    processed_sessions = set() # Keep track to avoid re-reading NWB if multiple probes in one session
