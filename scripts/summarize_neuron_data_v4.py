"""
summarize_neuron_data_v4.py: Aggregates neuron data (counts, r_fix, latency) by area, layer, and signal strength.
...
def main():
    ...
    if not os.path.exists(LATENCY_PATH):
        print(f"Warning: Latency file not found at {LATENCY_PATH}. Latency stats will be NaN.")
    ...
    # Ensure session_id, probe_id, unit_idx are strings for reliable merging
