"""
layer_mapping_omission_v7.py: Maps identified omission neurons to cortical layers (Superficial, L4, Deep)
...
# Paths
UNITS_LAYERED_PATH = 'D:\Analysis\Omission\local-workspace\checkpointseal_omission_units_layered_v3.csv' # Using escaped backslashes
...
OUTPUT_PATH = 'D:\Analysis\Omission\local-workspace\checkpointseal_omission_units_layered_v3_final.csv'
