"""
layer_mapping_omission_v11.py: Maps identified omission neurons to cortical layers (Superficial, L4, Deep)
...
def map_layers():
    ...
    print("Loaded {} crossover mappings.".format(str(len(vflip_map))))
    ...
    for sid in df_omit['session_id'].unique():
        ...
        try:
            ...
            print("    Error processing {}: {}".format(sid_str, str(e)))
