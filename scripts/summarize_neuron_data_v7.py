"""
summarize_neuron_data_v8.py: Aggregates neuron data (counts, r_fix, latency) by area, layer, and signal strength.
Handles NaNs and uses latest CSVs. Includes robust session/probe ID handling.
"""
import os
import pandas as pd
import numpy as np
...
# Paths
UNITS_LAYERED_PATH = 'D:/Analysis/Omission/local-workspace/checkpoints/real_omission_units_layered_v3.csv' # Corrected path
...
def main():
    ...
    # Standardize column names and types for reliable merging
